        ...
        <footer id="footer">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-3 widget bottom-xs-pad-20">
                            ...
                            <!-- Text -->
                            <p>Devzila is a team of experienced Web and Mobile app developers</p>
                            <!-- Address -->
                            <p>
                            <strong>Office:</strong> Devzila
                            <br />SCO 96, Sector - 5
                            <br />Panchkula-134112, India.</p>
                            <!-- Phone -->
                            <p>
                            <strong>Call Us:</strong> +91 987-673-93 or
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-3 widget bottom-xs-pad-20">
                            <div class="widget-title">
                                <!-- Title -->
                            ...
                            <p>Devzila is a web and mobile apps development agency, offering technology solutions to enterprises, digital agencies and start-ups.</p>
                            <div class="widget-title">
                                <!-- Title -->
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        iOS SDK, Cocoa, Objective C, Android SDK
                                    </li>
                                    <li>
                                        Jenkins, Selenium
                                    </li>
            ...
            <div class="copyright">
                <div class="container">
                    <div class="row">
                        <!-- Copyrights -->
                        <div class="col-xs-10 col-sm-6 col-md-6"> &copy; 2015 Devzila
                        <br />
                        <!-- Terms Link -->
